...
SYS_CHANNEL="testcertchannel"
APP_CHANNEL="certchannel"
...
# MSP related paths
ORDERER_MSP=/etc/hyperledger/fabric/crypto-config/ordererOrganizations/cert.com/orderers/orderer0.cert.com/msp
ORDERER_ADMIN_MSP=/etc/hyperledger/fabric/crypto-config/ordererOrganizations/cert.com/users/Admin@cert.com/msp
ORG1_ADMIN_MSP=/etc/hyperledger/fabric/crypto-config/peerOrganizations/ktb.cert.com/users/Admin@ktb.cert.com/msp
ORG1_PEER0_MSP=/etc/hyperledger/fabric/crypto-config/peerOrganizations/ktb.cert.com/peers/peer0.Ktb.cert.com/msp
ORG2_ADMIN_MSP=/etc/hyperledger/fabric/crypto-config/peerOrganizations/ind.cert.com/users/Admin@ind.cert.com/msp

# cert related path
ORDERER_TLS_CA=/etc/hyperledger/fabric/crypto-config/ordererOrganizations/cert.com/orderers/orderer0.cert.com/msp/tlscacerts/tlsca.cert.com-cert.pem
ORDERER_TLS_ROOTCERT=/etc/hyperledger/fabric/crypto-config/ordererOrganizations/cert.com/orderers/orderer0.cert.com/tls/ca.crt
ORG1_PEER0_TLS_ROOTCERT=/etc/hyperledger/fabric/crypto-config/peerOrganizations/ktb.cert.com/peers/peer0.ktb.cert.com/tls/ca.crt
ORG1_PEER1_TLS_ROOTCERT=/etc/hyperledger/fabric/crypto-config/peerOrganizations/ktb.cert.com/peers/peer1.ktb.cert.com/tls/ca.crt
ORG1_ADMIN_TLS_CLIENT_KEY=/etc/hyperledger/fabric/crypto-config/peerOrganizations/ktb.cert.com/users/Admin@Ktb.cert.com/tls/client.key
ORG1_ADMIN_TLS_CLIENT_CERT=/etc/hyperledger/fabric/crypto-config/peerOrganizations/ktb.cert.com/users/Admin@Ktb.cert.com/tls/client.crt
ORG1_ADMIN_TLS_CA_CERT=/etc/hyperledger/fabric/crypto-config/peerOrganizations/ktb.cert.com/users/Admin@Ktb.cert.com/tls/ca.crt
ORG2_PEER0_TLS_ROOTCERT=/etc/hyperledger/fabric/crypto-config/peerOrganizations/ind.cert.com/peers/peer0.ind.cert.com/tls/ca.crt
ORG2_PEER1_TLS_ROOTCERT=/etc/hyperledger/fabric/crypto-config/peerOrganizations/ind.cert.com/peers/peer1.ind.cert.com/tls/ca.crt

# Node URLS
ORDERER_URL="orderer0.cert.com:7050"
ORG1_PEER0_URL="peer0.ktb.cert.com:7051"
ORG1_PEER1_URL="peer1.ktb.cert.com:7051"
ORG2_PEER0_URL="peer0.ind.cert.com:7051"
ORG2_PEER1_URL="peer1.ind.cert.com:7051"

# Chaincode exp02 related
CC_02_NAME="exp02"
CC_02_PATH="certs/chaincode/go/chaincode_cert02"
...
CC_MAP_NAME="map"
CC_MAP_PATH="certs/chaincode/go/map"
...
CC_MARBLES_PATH="certs/chaincode/go/marbles02_private/go"
...
CC_MARBLES_COLLECTION_CONFIG="/go/src/certs/chaincode/go/marbles02_private/collections_config.json"
CC_MARBLES_COLLECTION_CONFIG_NEW="/go/src/certs/chaincode/go/marbles02_private/collections_config_new.json"
...
UPDATE_ANCHOR_ORG1_TX=KtbMSPanchors.tx
UPDATE_ANCHOR_ORG2_TX=IndMSPanchors.tx
UPDATE_ANCHOR_ORG3_TX=CmlMSPanchors.tx
UPDATE_ANCHOR_ORG4_TX=PolMSPanchors.tx
